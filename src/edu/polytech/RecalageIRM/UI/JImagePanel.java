...
public class JImagePanel extends JComponent implements Cloneable {
    ...
    /**
     * Update this JImagePanel to have the same zoom and scale settings as the
     * one specified.
     */
    ...
    /**
     * ImagePlus.updateAndDraw calls this method to get paint to update the
     * image from the ImageProcessor.
     */
